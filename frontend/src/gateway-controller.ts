...
export const createGatewayController = (gatewayApi: GatewayApi, operatorPolicy: OperatorPolicyService = createOperatorPolicyService((selected) => gatewayApi.saveOperatorPolicy(selected))): GatewayController => ({
