...
export const APP_STYLES = css`
    ...
    * { box-sizing: border-box; }
    ...
    .header-tools .header-language { min-width: 180px; gap: 0; }
    ...
    .navigation-tabs .ui-tab .ui-tab-icon { flex: 0 0 22px; width: 22px; height: 22px; fill: currentColor; }
