...
const TRANSLATIONS: Record<string, Record<string, string>> = {
  en: {
    ...
    capabilitiesHelp: 'Choose exactly which read-only data this client may access.', selectAllObserver: 'Select all', clearSelection: 'Clear', selectedCapabilities: 'selected · observer only', issueClient: 'Issue client',
  ...
  es: {
    ...
    capabilitiesHelp: 'Elige exactamente qué información de solo lectura puede consultar este cliente.', selectAllObserver: 'Seleccionar todo', clearSelection: 'Limpiar', selectedCapabilities: 'seleccionadas · solo observer', issueClient: 'Crear cliente',
